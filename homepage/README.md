---
files: [index.html]
url: https://cdn.cs50.net/2022/fall/psets/8/homepage/README.md
window: [terminal]
---
...
{% comment %}
{% if college %}
You should create a Markdown file, `specification.md`, which lists the 10 distinct HTML tags you've used and their line numbers, the five CSS properties you've used and their line numbers, as well as a brief (one-sentence) description of how you chose to use JavaScript and Bootstrap.
{% endif %}
{% endcomment %}
...
1. While in your `homepage` directory, create a ZIP file of your website by executing:
```
zip -r homepage.zip *
```
1. Download your `homepage.zip` file by control-clicking or right-clicking on the file in your codespace's file browser and choosing **Download**.
2. Go to CS50's [Gradescope page](https://www.gradescope.com/).
3. Click "Problem Set 8: Homepage".
4. Drag and drop your `homepage.zip` file to the area that says "Drag & Drop". Be sure it has that **exact** filename! If you upload a file with a different name, the autograder likely will fail when trying to run it, and ensuring you have uploaded files with the correct filename is your responsibility!
5. Click "Upload".
